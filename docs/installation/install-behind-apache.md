...
We strongly recommend you use our `baserow/baserow:2.0.1` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:2.0.1`
    and `baserow/web-frontend:2.0.1` images.
...
> the [deploy/apache/recommended](https://github.com/baserow/baserow/tree/master/deploy/apache/)
> folder.

Follow this option if you are using:

* The all-in-one Baserow image `baserow/baserow:2.0.1`
...
> You can find a Dockerized working example of using Apache with Baserow in our git repo in
> the [deploy/apache/no-caddy](https://github.com/baserow/baserow/tree/master/deploy/apache/)
> folder.

Follow this option if you are using:

* Our standalone `baserow/backend:2.0.1` and `baserow/web-frontend:2.0.1` images with
...
If you are using the `baserow/backend:2.0.1` image then you can do this by adding
